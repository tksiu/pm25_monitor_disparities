...
if (sys.nframe() == 0) {
   ...
   ###   Identify monitoring gaps of concern due to exceedances of 3-year averaged surface PM2.5 compared to WHO annual guideline (5 ug/m3)
                                              
   da$pm25_exceedance = ifelse(da$pm25_3yr_mean > 5, 1, 0)
   da$total_kde_gap_with_pm25_exceedance = ifelse(da$pm25_3yr_mean > 5 & da$total_sp_tw_kde == 0, 1, 0)
   da$fem_kde_gap_with_pm25_exceedance = ifelse(da$pm25_3yr_mean > 5 & da$fem_sp_tw_kde == 0, 1, 0)
